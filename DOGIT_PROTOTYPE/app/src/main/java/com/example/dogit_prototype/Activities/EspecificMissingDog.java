...
import com.example.dogit_prototype.Activities.MainActivity;
import com.example.dogit_prototype.Activities.MenuActivity;
...
//        imgEspe = findViewById(R.id.imgEspe);
        ...
        DatabaseReference reference = database.getReference(MenuActivity.PATH_DOGS).child(ID);
